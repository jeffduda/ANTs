...
#ifndef __itkMaskedTextureHistogram_h
#define __itkMaskedTextureHistogram_h
...
class MaskedTextureHistogram
{
public:
  MaskedTextureHistogram() 
  { 
    m_Count = 0;
    m_Initialized = false;
  }

  ~MaskedTextureHistogram() = default;
  ...
  AddPixel(const TInputPixel & p)
  {
    ...
    //std::cout << "MaskedTextureHistogram::AddPixel(" << p << ")" << std::endl;
  ...
  RemovePixel(const TInputPixel & p)
  {
    ...
    //std::cout << "MaskedTextureHistogram::RemovePixel(" << p << ")" << std::endl;
  ...
  IsValid()
  {
    //std::cout << "MaskedTextureHistogram::IsValid()";
  ...
  {
    std::cout << "MaskedTextureHistogram::GetValue()" << std::endl;
    TOutputPixel out;
